...
const Banner = () => {
    return (
        <div className="relative text-center w-full">
            <Carousel showArrows={true} className="banner">
                <div className="lg:bannerImg w-full">
                    <img src={img1} />
                    <div className=" text-justify flex flex-col justify-start pt-[100px] lg:pt-[250px] items-center  absolute h-full w-full left-0 top-0  bg-black bg-opacity-60 rounded-xl text-white">
                        ...
                        <h1 className="text-2xl lg:text-7xl font-bold"><span className=" text-lime-600">S</span>tarting <span className="text-fuchsia-500">I</span>n <span className=" text-red-400">A</span>ugust <span className="lg:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#ffff00] to-cyan-500">!</span><span className="lg:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#2835aa69] to-cyan-500">!</span><span className="text-transparent lg:text-8xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">!</span></h1>
                ...
                <div className="bannerImg">
                    <img src={img7} />
                    <div className="space-y-8 text-justify  absolute h-full w-full left-0 top-0  rounded-xl flex flex-col justify-center items-center bg-black bg-opacity-60 ">
