    ...
    return (
        <div className=" w-full  relative">
            <div className="h-[300px]">
                <img src={img1} className="w-full h-[300px] rounded-xl object-cover" />
                <div className="absolute h-[300px] w-full left-0 top-0  bg-black bg-opacity-60 rounded-xl text-white pt-6">
                    <footer className="footer ">
                        ...
                        <div className="">
                            <span className="text-white italic text-xl font-semibold border-b-2 border-red-500 ml-8">Services</span>
                    ...
                    <footer className="footer footer-center p-4 bg-black bg-opacity-60 text-white absolute bottom-0 ">
                        <div>
