    ...
    return (
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col w-full lg:flex-row gap-16">
                <img src="https://images.unsplash.com/photo-1560421683-6856ea585c78?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8YXJ0cyUyMGFuZCUyMGNyYWZ0fGVufDB8fDB8fHww&w=1000&q=80" className="w-full lg:w-[400px] rounded-lg shadow-2xl" />
                <div>
