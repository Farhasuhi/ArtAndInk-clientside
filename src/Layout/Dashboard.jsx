...
import { FaCheck, FaGripLinesVertical, FaHistory, FaHome, FaHouseUser } from "react-icons/fa";

const Dashboard = () => {
    const menu=<>
    <li className='text-white'><Link><FaHouseUser></FaHouseUser> User Home</Link></li>
    <li className='text-white'><Link><FaCheck></FaCheck>Selected classes</Link></li>
    ...
    return (
        <div className="drawer">
            ...
            <div className="drawer-content flex flex-col">
                {/* Navbar */}
                <div className="w-full navbar bg-red-700 opacity-90 ">
